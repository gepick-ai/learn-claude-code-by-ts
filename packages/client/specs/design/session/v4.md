...
| 日期 | 说明 |
|------|------|
| 2026-04-28 | 首版：新增 Project 区域；定义 Project 创建/切换、Project-Session 映射、切换默认选中规则（三栏布局下切换到 Project 时默认选第一个 Session）。 |
| 2026-04-28 | 调整布局顺序为「左 Project / 中 Session历史 / 右 Chat」，并同步无 Project 场景下的区域可见性描述。 |
